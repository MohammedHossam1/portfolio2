...
export default function NavBar() {
  ...
  return (
    <>
       <nav className="navbar shadow bg-white fixed-top start-0 end-0  my-0 navbar-expand-lg ">
        <div className="container py-0 my-0">
          <a className="navbar-brand p-0 " href="">
            <h1 className="me-auto fw-bold logo ">FAYYAD</h1>
          </a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul
              className={ "d-flex align-items-center m-0  navbar-nav ms-auto justify-content-center" }
            >
